...
namespace MyDictionary.Infrastructure.Migrations
{
    ...
    [Migration("20251213155328_Alter_Entity_StudyDeckDictionary")]
    partial class Alter_Entity_StudyDeckDictionary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDictionary.Domain.Modules.StudyDecks.StudyDeck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MyDictionary.Domain.Modules.StudyDecks.StudyDeckDictionary", b =>
                {
                    b.HasOne("MyDictionary.Domain.Modules.UserDictionaries.UserDictionary", "Dictionary")
                        .WithMany("StudyDeckDictionaries")
                        .HasForeignKey("DictionaryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyDictionary.Domain.Modules.StudyDecks.StudyDeck", "StudyDeck")
            ...
            modelBuilder.Entity("MyDictionary.Domain.Modules.UserDictionaries.UserDictionary", b =>
                {
                    ...
                    b.Navigation("StudyDeckDictionaries");
                });
